...
const Chat: React.FC = () => {
  ...
  const handleReplySend = (commentId: number): void => {
                  ...
                  <div className="text-xs text-black mt-1 flex items-center gap-2">
                    ...
                    <div className="">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent className="" inset={false}>
                              <DropdownMenuItem className="" inset={false}>Edit Request</DropdownMenuItem>
                              <DropdownMenuItem className="" inset={false}>Delete</DropdownMenuItem>
                              <DropdownMenuItem className="" inset={false}>Copy link</DropdownMenuItem>
                            </DropdownMenuContent>
                          </DropdownMenu>
                    </div>
