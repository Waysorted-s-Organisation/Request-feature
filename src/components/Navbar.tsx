...
const Navbar: React.FC = () => {
  ...
  const [board, setBoard] = useState<string>("figma")
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <RadioGroup
                  ...
                  onValueChange={(val: "feature" | "bug") => setType(val)}
              ...
              <Button 
                onClick={() => {
                  ...
                  addMyRequest({
                    ...
                    type: type || "feature", // Add required type property
                    board: board || "figma", // Add required board property
